...
const GetMetadataResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'build_commit_hash', '3': 2, '4': 1, '5': 9, '9': 0, '10': 'buildCommitHash', '17': true},
    const {'1': 'build_commit_timestamp_seconds_since_epoch', '3': 3, '4': 1, '5': 3, '9': 1, '10': 'buildCommitTimestampSecondsSinceEpoch', '17': true},
    const {'1': 'beam_sdk_version', '3': 4, '4': 1, '5': 9, '9': 2, '10': 'beamSdkVersion', '17': true},
  ],
  '8': const [
    const {'1': '_build_commit_hash'},
    const {'1': '_build_commit_timestamp_seconds_since_epoch'},
    const {'1': '_beam_sdk_version'},
  ],
};
